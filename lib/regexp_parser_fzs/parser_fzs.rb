...
require_relative 'expression_fzs'

class Regexp::ParserFzs
  include Regexp::ExpressionFzs

  class ParserError < Regexp::ParserFzs::Error; end
  ...
  def parse(input, syntax = nil, options: nil, &block)
    ...
    Regexp::LexerFzs.scan(input, syntax, options: options, collect_tokens: false) do |token|
      parse_token(token)
    end
  ...
  UP = Regexp::ExpressionFzs::Property
  UPTokens = Regexp::SyntaxFzs::Token::Property
