...
class Regexp::MatchLength
  ...
  def self.of(obj)
    exp = obj.is_a?(Regexp::ExpressionFzs::Base) ? obj : Regexp::ParserFzs.parse(obj)
    exp.match_length
  end
  ...
  def inspect
    type = exp_class.name.sub('Regexp::ExpressionFzs::', '')
...
module Regexp::ExpressionFzs
  ...
  class Subexpression
    ...
    def inner_match_length
      dummy = Regexp::ExpressionFzs::Root.construct
